...
def retrieve(
    ...
    # Fetch a wider candidate pool so RRF has enough documents from both
    ...
    if use_reranking:
        ...
        # Dense-only mode supports the evaluation pipeline's A/B comparison.
...
def _normalize_results(
    results: list[dict], source: str, top_k: int
) -> list[dict]:
